function Assert-ConsoleFit {
    <#
        .SYNOPSIS
            Clamps an asserted line width to what the real console can display.

        .DESCRIPTION
            A width that was asserted rather than measured (the Width setting or the environment
            variable) can be wider than the window, which wraps every line. When the console width
            is known, the asserted value is clamped to it and a warning is written. When no console
            width could be detected, the asserted value is honoured, because that is exactly the
            redirected or headless case the assertion exists for.

            ForceWidth skips the clamp.

        .PARAMETER Requested
            The asserted width.

        .PARAMETER Detected
            The real console width, or 0 when it could not be determined.

        .PARAMETER Source
            Name of the setting being clamped, quoted back in the warning.
    #>
    [CmdletBinding()]
    [OutputType([Int32])]
    param(
    ...
    if ($Requested -le $limit -or $script:ConsoleStatus.ForceWidth) {
        return $Requested
    }

    Write-Warning -Message "$Source of $Requested does not fit the console width of $Detected. Clamping to $limit. Set ForceWidth to override."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDSbtdkmcDvBjrs
# t/ioPXSXg16vlehajv2VZaa5HLnpjKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg3avJ
# V+Lqvkpmc4blS6YE2g6GIbYbGljQzd7Y1vdU71kwDQYJKoZIhvcNAQEBBQAEggGA
# f8fwshUOJ305blXGoF7VD7g/i1EIXo48zv+lqlkhSMZkbkyn+mLOMsUg5xOcUrb7
# YUSO7iSIWJpygm+DCtqNqhKdfTPCYNqhXh0zGvJT1iwEuNTjI0bMwKvZN1IkyFXP
# JmeyCfxAOVd049hYh7+mS4Ml45CnVsx87XRSFtA3MOxB407imT/9c/tdkML0VcQJ
# LYHPnTsheRNT8wtn1iv5HbmrznjVTTHzingwjV7rDFBJDU1/OSw6HTuc1dQX0Qju
# 3Jf8fyKrm5JpNO3WPW95mdiKbqjB8XVyOx+l13Qpl7+g4SoJ4xFlALjKVzoH6pnA
# y2jkxvzl8M5DbcW3cVdn7VLTjs70518A9TiB0NFvJDsk1hFgUF272nLtPljo38/h
# jI+h51l2D9T9S6JgTuEX+nIAGoS5ZVnNM5QDRKMhnlNZrJhCbfxEi+71IYEXKveo
# utqw7wZ6hXZVYYjNm86iCwAcmQPo426cKe6HbtS79oWUPJ0nTUIEOpq/yGLIKmzY
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIA6zS1vGAE0qtcXJXTW/
# cLiW/4vyv88JVrztEMD5jNPZAgZqdgnSPnMYEzIwMjYwODEwMjA0NzIyLjA5Nlow
...
# IgQgkTAy4suyxrJ+cU+61BlqvBp7BIyMFVUYlJYSz5zi40cwgd0GCyqGSIb3DQEJ
...
# PSanbLLmZ+tZpRgaUQwIiab9pTANBgkqhkiG9w0BAQsFAASCAgClooA8ohicDM8X
# Q4lXz5JYBKPAPb+Y5Lb/3FoWnAutlnMs8AxM+H3WnU3Dvl9KAQQEDcTr7tkrTEqW
# 5hJ9/fZhsoTG/Y31RAjltxONhBuJH5c/YZUYN2H9hztEqZ7GL9SRUbVzZ8U5SW47
# ChPuTDWjgBqR8q785IdQukEpLMnXokU+ipdEvhj/2l8bz5F6MRYHtiZeINJdyvRL
# N3z7MPUzadT/tdaZvjLM/7eC5PDy0hfI5D4m05glQ7C983fReYIb3C+hJnUnM98L
# DNrAmkBFsFJeQeL2r8QOVuvnNQ5U9Xmn+fop+IYIrj6GVv8AajD2pvteNmEeL9mM
# BoVXu//38Wsq+4GGm2F3XguGCA9bVsM/HnXZIXJjQiItxDaKrQtAfzFGTSdRzuBF
# 3IQS0ZRj5E7pg0GkVav23j2qECuHIG+XT9AJrjR5xMk2kdnRmQfs9d3qzHs2KiWd
# v5dOYUSp23L8PjWXHvWn6hXbJyqHwANkV6XwvhAyCbcE+bwBzVM4PCYwtXxQ2Ztl
# mzsnQgzdGOJJH0vMkzN6fipXEIUB/EMYHm4KvJ75XRoWkVHn+h4j0L4kr9FSLyIe
# NqP/NP79lki9jqrTHX73Hx5RVZB7aNL2vkvlpvAtzUq2swWPb5VJgKr602W9Ph1i
# fjRSj5UGxcej/AI5HorrteaLZQ88Pw==
