function Split-TextToWidth {
    <#
        .SYNOPSIS
            Wraps text into chunks that each fit the given width.

        .DESCRIPTION
            Breaks on spaces. A single word longer than the width is split hard, so a long path or
            token cannot produce a line that overflows.

        .PARAMETER Text
            Text to wrap, already flattened by Format-SingleLine.

        .PARAMETER Width
            Maximum length of each returned chunk.
    #>
    [CmdletBinding()]
    [OutputType([String[]])]
    param(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAwWEl7v9p4JqhC
# n+jmohIBZIIAofIJUjHUkP3UcncYtaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgYS2U
# rrJ2URRDBoCA21yYXxV5Ul/BbpTtruxbPwFH6rUwDQYJKoZIhvcNAQEBBQAEggGA
# kT8O/qRyKEyml4oavvsTTIgo0IVVBczSm0NLyh17AkCOLpDanNMCoqpl8zjl4dZb
# FnGJVouVHnwMbTfw3TsEYF+MgFYWZiOP3cFNI8mJ4FVn5oru97N9UDAEcxBR4Jm9
# NxltZMp8hSSeGN2E+kisaZK3dGLQ7R7743O9BveN0xYmTNblWo+lu1P5p5D9d432
# I8S1K8QxCZxPGf0jnafKLWe7RzQUcs19s3u4yqZW8NoL/R39D8tnAnKrjzu9HSXt
# aTBlfUMoL8zRkPN8n89K+MuqeNNSZIFwr80uGqxBCmuhZvu/qWnPoyZKKSMpKkHb
# 9O+WAk2z0C4d0pvtHOi9oWxERap517+Vjw0DxvK4DDBSvEgdF0CbThbVGo229Mta
# Ya7PSoheHw96gxiW2gwRk10gz7YaKG4rH+VKhI43alr1q2Z5h2Jo3NoqxnwJC5eD
# gqQAl+5//AdfQ/MhJ++tY8OmY+UjGysmz/F2/LikL1+y1xLCdHnh9c1NE+U74sEu
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIDVunfIZPtHrmxqX4970
# rUbPttMB3dPaKs6xoFXo4FdNAgZqNTBzBUYYEzIwMjYwODEwMjA0NzM1LjEwNVow
...
# IgQgofAp7WgaYns8dP8BkOLVkNSnlZFr7fs6LCPOGHc4Eqswgd0GCyqGSIb3DQEJ
...
# r2m/ztk0VK82Yn22ky/ozUOgUzANBgkqhkiG9w0BAQsFAASCAgCzScr/Q7WFJAIm
# U+w4z0whnIE3BtLoFax8pDAXFa8PCYJAFWwo2Ai2ngSENM9A02emsu1Oh/ykpGZn
# jD5sk+KNOu0AnIHAi6WfVfjw5O8Do+6y+tILgQb8PUaKYqHCqy3wAIInsNnLMhsM
# VCDtXfAsnrJ1aB8qg6Q462koPji7yc62h21yBx3AsU2ZWnWTHePMr0KsbVYP7dyK
# JmA6JlV1Y7T5QxyvfYHmmCLfbpbeGFreE26j7EGGqG55ViSiJakYXAGEhz7sbBLg
# Xb7dUnbPypBVQ3HdOxtyG8XDDtqVfsq94yrszSJ4kGHjuiYmm+hFovjHQOw1mOfD
# jSjk7B+KT2NsofmTe1yB6MEVluNBGdIcau6swbxHBnBu2NfJY/m5Nv9ngSrdrHuU
# 8VDMXdw+s0vmvJ6dJ1YpolKHgrTX/M54A5EVBWH/SNuk/BanNpvZakZKW6Et0kf5
# V6h9RjvNTZSXDy7xyL4ZSUq+X7d8aIrk/vZWsC9X2M97hSxLv5nngTC1qeQEQASg
# DwdvdlznoecMp2PGKKOn69H+rnZi7LQcCcm5p7s7QH0OPHR/11h2Iwi/kkpsLtIg
# GGBPpC7anNiM4urvKf1zxq3xTT8Vic0XGSqb95yG2UEibRt+e79R673MBMmCbPB0
# n155nOObQ2CgIV/bvy2gGxGkybAQgg==
