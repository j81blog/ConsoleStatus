function Get-DetectedConsoleWidth {
    <#
        .SYNOPSIS
            Returns the real console width, or 0 when it cannot be determined.

        .DESCRIPTION
            WindowSize is deliberately preferred over BufferSize. On legacy conhost the buffer can
            be wider than the window, which is what produces the horizontal scrollbar, and writing
            to the buffer width would push the status column off screen. BufferSize is only used
            for hosts that leave WindowSize empty.

            [Console]::WindowWidth is not used at all: it throws an IOException as soon as standard
            output is redirected, which covers every piped or logged run.
    #>
    [CmdletBinding()]
    [OutputType([Int32])]
    param()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCA3y9aWcOeOai0
# 1y36N8eUGL4d2+1Ld5FAelMugim4SKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgNiw/
# NUed28KuL5fzmyGTzvEeOCo4QMK5NpFArgCXjwkwDQYJKoZIhvcNAQEBBQAEggGA
# RqqemenApdqeCsz/bRh/1DmJv33lPwhu4WJm0nWJ5wU5+6mV8MufEJlGklocag0s
# RUHmcgtcXsClWlhH/mqbfAuS0FylU84YjCytPWhA0HPDvcHASpTDNccaqL4J9JbZ
# mktIbPATkM1PyTYIMijOVx4kIZBx3GSO6M1+5pql9GDDkNFzNt+jeMOmPUwMMUsD
# +k3fQgl9n6sS/H8My/zIoLMOX7Ak9v3m0WXY7ZXwAt5gnUWsxtZDmogHLKKz2tjQ
# kE+HYd4sSTpK2Tj4xp+h/KOcE4hpkg4hwEPe0sq1koOyLZ0jzs661e0EXGXLRdtX
# wiy14pIsk1eriybweZPsCz0zAoQRQDvKUa8NbNtBjOeqAp7FJK7GVD98hU+x4qlQ
# 8d2K7RM671zzCI10CDaN5iRAtlHg8fH4gYi28upY0JmUXUNCHtj0WHrQn+EJ0cc0
# QRySvYceFUnFp7rqRCaxu+yf8+RDGezvmg7XcApOdudxgdYAPWbt9fu9RHA60BfR
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIPQyaklgJMzhUCriDH/7
# Uomx0BbJQf3ZgDKdyN/b6eb3AgZqdgnSPq8YEzIwMjYwODEwMjA0NzMzLjA3Nlow
...
# IgQgv4hRwCrtbJG4fsL1OA0Jtzt47bB7lQzHcDSDqJwx6Bcwgd0GCyqGSIb3DQEJ
...
# PSanbLLmZ+tZpRgaUQwIiab9pTANBgkqhkiG9w0BAQsFAASCAgAy+3rhc2A5JvVQ
# 5lqLtRSFe6O+J6ePWglcKCcVMvC3b9KZO1yUWe1t2O2yEj8rayMMFnSNgCHeROc7
# 95X39rvZbOg/ZzAHdYwqmF6UMQWQtdC7OPs27GbArLdYn5EIWe/pKc+wQDUGwCHq
# ahFa4lTzXC3BhHDS1GIaW+dSufGm7lI3dLx40seD5CMV0NEVavU7XOaDGxGpb6JN
# zZ0rlZnCUKSRx4QFVV5Tp3zRBfRg/9H1PszajaoBObr4FdXKcg9l9wwaKTzTOCiM
# MFMD/KmPSH4NTZesBYahQGh7HxOxwAxEqmHBE9POeJlhiWzD9lzo4fbtc34bXVOv
# 8B/PW6DzDmYukcFy+FkOwwASiaZWn0SiM0AqlZErcHRm7YcClcBTwJfWy0iJDjJc
# 2R6bY4pvWh2IA3izlupjBMeMb9/omjbJAoAbVaKq+lFJAQ9VBN+8kxoCCUuh/zWV
# k4IKM/LDgs67m+tuF0Rvzer5SCHLXe/7GPbvEm9MqaqeUmfDLtYH+mUD3EdElfjV
# zHV9w418mkNYa+t9AWie9pAsgN2mpEnnvkD9nosi3DHXgFZdMVsm9s16qtJmeBe8
# Evt9Jhww3oy0FYOxR6f1k877feDqrlFvMetMEhoKFic3lWEv8YfGtN5telaV1s+P
# ImViSNdGTB8dLopVZgu4skstmFRJTg==
