function Start-ConsoleContinuation {
    <#
        .SYNOPSIS
            Closes the current line as continued and opens the next one at the field column.

        .DESCRIPTION
            Pads out whatever is left of the field, then indents the new line so the label and
            value columns stay empty. Only the last line of an item carries a status block, which
            with the empty columns is what marks the earlier lines as continued.
    #>
    [CmdletBinding()]
    param()
    ...
    if ($cfg.BarContinuation -eq 'Blank') {
        # Same gap as the status block, so the bracket column lines up.
        Write-HostText -Text ' ' -NoNewline
        Write-HostText -Text '[' -NoNewline -Color 'DarkGray'
        Write-HostText -Text (' ' * ($cfg.StatusWidth - 2)) -NoNewline
        Write-HostText -Text ']' -Color 'DarkGray'
    } else {
        Write-HostText -Text ''
    }

    Write-HostText -Text (' ' * $cfg.FieldStart) -NoNewline
    $cfg.Ticks = 0
    $cfg.BarLines++
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCOhmnh/LTTkQkU
# caN1qXZZZeMjvshUc2YkLGyZaL2N1aCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgb/8i
# qpYhxGRWT2E5fbR5SMR8OMlcsRf6vGbya1qzSjkwDQYJKoZIhvcNAQEBBQAEggGA
# YiQ5o2IcOsWL4rcyjIwwHia1nEkC7jbbwXDC0xTENaWKaMlVtsP1Dwnnd1Rd7uK9
# YuhWfPxh2ZMTK21NPvM5S0fMRXPoL8wQ/JpfWQfDxZzdweiXd9uBo9Q2D9xbNtHU
# UAQ8AuPz8CiSp0xPKUxmhXXxomSYkHG75q/VEwl0qLMBQvaoghx4YbY5cErs0+I0
# ICjT9WfWOfE443GK+9AbB7Y0NKCyb2RUhY4AlLfPkU2ZsmrePEihnPHmgtkV8vsw
# TTWAtP/kUm7pxo/a6UNp9qr5tRemrKclOE7R7/ac6jgsdyZENPW0x3TZiIbpJQrh
# xn1njVjvsM9IiSgTJOHOpzhadpBTLQMOAeuRyfKQUz3eMyCr5kETcj6M0vNdvS93
# ec6S77ukf+zDYbAGR9Wo/WePM395ema3edqb+YTnR1pJQm8uFQywbnjTnO/zQwT7
# dglPPKcaDr9dKipjBFcbxAAfQCf+5zpjyKqXJRoJj0GSCylYkGMqonQtU0Q3VLtU
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIBkxxPrllOBX0dfC7ywq
# k1PN3LfSh8eN6abq9u3sY1hRAgZqdgnSPsIYEzIwMjYwODEwMjA0NzM2LjE4NFow
...
# IgQgPct015GxHfhCA9meoJ1T5ZGml45PvaGFSnGRJzMBFXcwgd0GCyqGSIb3DQEJ
...
# PSanbLLmZ+tZpRgaUQwIiab9pTANBgkqhkiG9w0BAQsFAASCAgCh4/jKVf15UA3O
# s6Bzwau0qt8SyUI0PDNSOx66l4GaDMvtwIfT/rJbAA7+fCj/lWUx7FwXS8Yim4N7
# F4r7bNzSO6l7EK484LUJOcBUPES9LeMiR1O53MkYbLqBfFo2QmHVClF2rQuEjdhA
# RWl7iriNkgZpS3sM3Hr1XXY2MOXCMXXuF5wuO2IxP1oapcs+cuT7S6yua7RBE3la
# SxLlPMddDdld1nkGnwnkYr1m+pHLpVXghlqlMRYoxbIHcApTcurF3i5HMaDoy4Xj
# ePu12zm1qDKOHXhXtTnG7QD93NyTBpS8GhCmqmFkYynR2BZz+PK6KqFgFDBt64ub
# 6XkWPVM5zi8wH2XljqQonPEX0l/bljL487m1Sno1hXb6fHqFe3rO9GVLb+tdpvaL
# 5dxbV3012haAK/atjzTPhNb6YcGe+/GWdHCM6VLG6+F2Pe1jjCb7fWndAcfWZ72C
# 3A51yjZQL985hPIKIqYn9UQBOThIDKTWdD3wH9Tb15U2WSpPqbdhWS5TM14IGTRy
# kflk7W+pnwWmwJIHxhqC7GkRlAqRPrmWXIGRyuw/PHL5IU869MvjsPJEJ1YLfXyn
# Lmc5HjqtiPyBGwshYPDn/hTAWKf1SbcDSKuzolBitu7w62+mJ+DbIcg2hlMZ8w3i
# 9zpiGCZ8ffYmXx0TgwZUEQHDfc23dQ==
