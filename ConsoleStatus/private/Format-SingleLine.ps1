function Format-SingleLine {
    <#
        .SYNOPSIS
            Collapses all whitespace to single spaces so a value cannot break the alignment.

        .DESCRIPTION
            Applied to everything that reaches a column or a record, so an embedded newline or tab
            cannot wreck the layout or split a log record over two lines.

        .PARAMETER Text
            Text to flatten. Null and empty are returned as an empty string.

        .PARAMETER KeepSpaces
            Remove only the characters that break a line, and leave runs of ordinary spaces alone.
            For text that does not sit in a column, where the caller may have aligned it on purpose.
    #>
    [CmdletBinding()]
    [OutputType([String])]
    param(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3bqjAeYQrA6pN
# lzcCrxAZPeGo16+rrHdipbEVY59DgaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgXHwG
# ebuWvPfh10UN71CpRhCd1f78fRYJiEhwL4MXt8wwDQYJKoZIhvcNAQEBBQAEggGA
# CkLKPYKA6e9ReJWjbvn8OiyFu1em2pr42oeWoMAQWjE41i6pvdLJqApawgUl6kNM
# r0kZzdb7ivOBPpWsf+alQ3XED+pL3eTul0sNJd8NtOC7iQIE6Oc5eihrLU8zX0WR
# QiXwczRqNewlPzKb4pUE0BISzAQsLAjZWj2wT8xbOF4hXYikQ+ihN6Hqn5ioj44w
# MqpHb/EI2AjtU7edBVH8BaGaMARzP6NlhlY+ejHg8nx+Yr28hnco5iQappiQpPl/
# mY8QWFp4rK0AJa8E6jZAkOTFRw4oA5kGuiZsVVfPfAUPu+W5/8cBy0GpoRaRxJXI
# NH+iOHmge7lixs+Q+H7waBPoD/S3vLD0nv+HgMnXj2CSdk72zuhdBjsfgjlktxod
# T1agsba1hXB9lod6w/+JmCodbFL+N20RMTkK53vePlZ5CRXcSi1CMK5JDg17e8eA
# WeZKD92krB56SSp+zoeD3/DfDPZxmzN3RW6yJnHXRNQHup+h8oRNnCY1h7/H3NKQ
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEILH6go9mPWf+CT1zZFwm
# Yc6dzxrQpn9IP2Q9T9OYqLvAAgZqNTB5fzsYEzIwMjYwODEyMjEyNzM0LjcxOVow
...
# IgQgREce3ve0Rxlmy//CPYCwo1G07WTPpL2+9XL/e5GkWeswgd0GCyqGSIb3DQEJ
...
# 8eu6iE+ys2Gla/OL9Xks4QhzNDANBgkqhkiG9w0BAQsFAASCAgDXzHduEW/05ZIu
# jIAjYDx9OkBiPDAe+ZRohYYzkmQU5JvhNTV4Xh2H2eFNrh5sNfKf5tQuPjLTb367
# J+kHHuI15nOnZoGasWd27GmEb6opsKT6miGIqfiGW7LJ3VsnXqWRKPegWX2QVnlg
# +vit1ReLuYflouspKVJe3AHVDgjeXsMzVtxLqoP6N46Rrk6WlQeQg0KwbNVIuOxu
# /p+Q63Dc2SVXfSNqg5/mtqbW1opFhBH8O/tlPVSGvGK+kiMpbEjAwLZRbyPU7ZnI
# JRmmTKz0rcA/SRY89ZHzDbDIu36MUytkrTwHeN9idMA0lMm2esVdewNlUFEHvNLP
# UIiL1mkOBZ9sdmHgU0Fyux8iV8kKN3cns23skEIP0dQmn6/rbPD7Tkms5xGz3WZm
# lDZEQOyAP1hvUn/ZUZWNiWdybOOob8eXrre/vTOvNDLcRxBnHDZKuZ2BFUltZN3E
# uCRoJEMPo+UpavUW8G5bgk++dtAIvp47gFkvNxEDCZfnOxZLrqh/VYZl6ZQtz3u1
# wQ+Bkd3IE7akmrNHGoz8om6Uj33rhoqdkxTJcIwT2VpWc8UZNr0zu9vIswDcaxos
# xomV0aINjf7t45B8LIy6n+yj72NtIBMqtk5wfGwqH0Q/bCfAdO8q2OFSBPY6ADS8
# 1/aQmis4xrplTHkjhI0tUQ+38+KxIw==
