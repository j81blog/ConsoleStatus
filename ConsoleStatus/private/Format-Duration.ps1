function Format-Duration {
    <#
        .SYNOPSIS
            Formats a millisecond count as a short human readable string.

        .DESCRIPTION
            Rolls over into minutes and hours, so a long running step reads as '4m 12s' rather than
            as a large number of seconds.
    ...
    $totalSeconds = [int][Math]::Round($Milliseconds / 1000)
    $totalMinutes = [int][Math]::Floor($totalSeconds / 60)

    if ($totalMinutes -lt 60) {
        return "{0}m {1}s" -f $totalMinutes, ($totalSeconds % 60)
    }

    return "{0}h {1}m" -f [int][Math]::Floor($totalMinutes / 60), ($totalMinutes % 60)
}

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCBjjoCu5wdxphd
# Y53IIonlxHldlavgamQuLTU64+ErzqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQghBAh
# PpBV4ilGwJ1KnbBUxuV/FIk9SQB4tPc+Z6stfhcwDQYJKoZIhvcNAQEBBQAEggGA
# mLtdQMM7lkeJmXif5dZ4VLaXA7IWQhhqcrkDdmH7Yj7dRmLR34OZYbHrWcRMSwhS
# HK/lC77dSifQnHqift825DdwDR9f+D4SE5e32FWz7ueXj1gKz3PqxsHxYaX/88sv
# fCi3ve0tM9zCGvl1fEYG4hRFW0ZXRrhPWeD5+mDCpgKIyR7gKySw6J3vkvQR3jjU
# BD7KOMgQeeVS1RsqRjJIXgQR0CrhHvG5SM/mjgbl+2FM3c+ooAtLBRm9q4ppb1MO
# JqdUWd7f91BDmTk2xHzWiVJCMGtYggH8c/d88fgaqceLlRQihoKkD9VGaZwKFWv1
# CM5SMdoRGTj542WaMtLQ5AlPcMMKHlv5Iems1ZL8p3yGj6pEAFKuSEcszM8GoUs/
# hkYPQO1DBcqHYqS2tiWYdlO5pDPOS6HVXnVlpvDs69djssevVnrvD6/Cnv6oriN/
# BzvCm5P0bTVZKYU68Gbea5NYJa5D+3X87cGuA9+P+IZ30hN9QRydsUZsZAF1YGWm
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIHf0WH1yT71xgQl8AkWE
# elh97SbRU5SNvBxU7AXFOT94AgZqdgnSPoEYEzIwMjYwODEwMjA0NzI0LjQyOFow
...
# IgQgoceCx2sLf20USb3d6vF0Fa4M1WZRJ0JXK1UkqPAeYpgwgd0GCyqGSIb3DQEJ
...
# PSanbLLmZ+tZpRgaUQwIiab9pTANBgkqhkiG9w0BAQsFAASCAgBrimGh2JOzERKI
# 4MXsCTzWrOxR1Dz0B1WoHlb2577qNjC8HFa4QqjNtEZOqB2H/ypeW6uhnkA41107
# yscgFrJc2Ji8/OFZ4jNxxoNodfziEu5v8XCi14Z4f2DiE4yUun+tyGwFtDLrJAXP
# VgnmSkHBtk2rusLAt7+LphQGVG2T9PK8Hz3NzOOGUnq4IXBjjQY5SxbGGMi+iD/A
# vaZfb/oqJV3RE6M5Bhzb10sZKwv5yM73PX8Vc5YHd03ENnEpGOFjrHCpB5FLaGWV
# CsNf1Ojb2xTqbam+Vy9w99SM2SJXXcAqVT7vqo7VVNU3oWqQw+0AjocWrOhqVGCQ
# 1xjnmgxVRv3PLakgKP1pwOABaJ8FRSdbEUcr2LHvPaQqtoP97JtbfPnQwIHRyn6z
# 2PsQ8lEouueok6tTonzvIh6f0EezRVMvyhOD26MM6aHa/E5QU6EJqb7uu6lLc+4j
# mV50ACijqEL6Hcwqhi42DZMbS5Hp1pMPppyEPkldpv00GJUvMmGSRSS4+B7xCBYz
# f1AhN6N3eLCRH9jaXcULeu3QrMjZ1PETLpTcHVIkdyajjBBmQamH4GgtVTEKVFcI
# cm80EShXLuaqIgHr5Q2wUnJBUMSkVaTAEeQCakeofmCei7ybUKeoRzekE/PXVs9Y
# zagzYp8PRA4MPc/mcDfY+n+RhEIamA==
