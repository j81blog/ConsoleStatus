function Write-HostText {
    <#
        .SYNOPSIS
            Write-Host wrapper that drops the color when NoColor or NO_COLOR is in effect.

        .DESCRIPTION
            Every write in the module goes through here, so colour can be turned off in one place
            and -ForegroundColor is never passed a null.

        .PARAMETER Text
            Text to write.

        .PARAMETER Color
            Console colour name. Ignored when colour is off, omitted entirely when empty.
    ...
    if (-not [string]::IsNullOrEmpty($Color) -and -not $script:ConsoleStatus.NoColor) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCCQMlRacsr+VWy
# ODVqWiRVuMQcUDS/lz06E+cpL71AYKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgkpx0
# E3696SYOs6FSU88HezQkSLvBAm4uTGtg3kS4kzswDQYJKoZIhvcNAQEBBQAEggGA
# HiElMQuJhYkj7foy5QRk68ZRwBNV4MP2ji87XW8YzmXxIXxKlDa58brZK7rTOORQ
# iygxlth6tLGYlNIywtLjkWLsdzVxH56jUAU75Uxl/KdEbH76iR4h57wwuBjz7+J8
# IRWekl3PE5hMUHZVX8ZoVS9FxAAxn37co4Y7sBVqFL+sU+Yc5Nmxer8gCVpwffEA
# ck7HnoKtdj6C5ZaHKCqFvMHLegkxACTOT1LVuY90BVZdSRrb9Q1+AiwtDUeNOf24
# e+X/XonYG1qH8imTpBispMpiALU1NKJuDFvlRswJDaOnaVh3HvurX2+sdl4/mvfV
# 8TtTmyvcdrXMFmUL4DSV//jEh82uCCVS9x1Tc3u954KgWS37CP6JRjO+4l3/Ye0e
# SGXtMESEGUEgJgOgG5T7O1JK7jUN+AuYYwxx97xL2bJNoYVFO2ovE5Cq5CWAc23C
# W7fz57swcVmbbmpLmBmlMJ9gD2i0IJBJwBCMoG4j9XM5G/HTbPKOdiFvNkpcElgd
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIPC1QjSNTVyCV+oi86gr
# uM1HaqgAIBFeM5teAz8SK4nbAgZqdgnSPuYYEzIwMjYwODEwMjA0NzQyLjMwMVow
...
# IgQg3SGbymSWHxAlUvRSoWN0hp+drzVR0NoY4WGOsY9POPUwgd0GCyqGSIb3DQEJ
...
# PSanbLLmZ+tZpRgaUQwIiab9pTANBgkqhkiG9w0BAQsFAASCAgBCfLmv5ClWm+37
# 07xhV2BT9eg5Ro3bJmZi0RUi4DSUAXZr07zoKvQWhTmcJMGuxSOJgJyEMwp3R8wb
# 5KOYdgxgj7KxMAWClWiCPWK3cKyXTI7KzkyQYe8gk3bUhrq/KeoNHAU8531ADVqb
# lW2kSwrfNivlwu2vhJR6W7icoKAh9hQfvAZ1JOB+J8l4cxmy3f3gf921RmbWT1pf
# xNLAUp+twJg9n5LP1UKt/B+g32Xi2CRV5fMBvDGUrOyQOpINC3N2MroJjfbG6e+H
# XKKOEVwKpHOvCrWMxatyfnRl92sjdcMBi9oKQ4yfkeCHTfiumNiJRvwOTvt54mws
# Zk9mO5bUpM4A57eHXnvEyu6OzpHbtqctjGEYVMpZt0JCSr9EbwzgQNkS2UwOtlmW
# QCvaddk5bP4G8dE1tU5L2XPSBb1BuMkDgS9uZ1i7JWk9q0kfixdjU5LVTjoJIsiW
# KHH9ZnwpK81lTqPpXmMNQMkuHsGnXb+kEwBa2sgvVEEmK+6cVGxXAp12wYzRS52m
# RFkMXGi+c3p29kRcBqdkxPDoDaQUq26bOQelx0uPWK7AO9EFZaEQnHm225FChcU/
# LptAXZSgaP5ERCMwZdONW1awCZEBY9GBNyb5PXD9/KFxMpvaJovaUi2uqTqk2Hz1
# k3iVbh0GvvZDDOaVX9JmHMSO/VlpJg==
