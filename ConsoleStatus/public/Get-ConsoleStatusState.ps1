function Get-ConsoleStatusState {
    <#
        .SYNOPSIS
            Returns where the renderer currently is: the open item and how far it got.

        .DESCRIPTION
            A deliberate, small public view of the per item state, so a wrapper can ask instead of
            tracking the same thing itself or reading module internals. Get-ConsoleStatusStyle
            reports the configuration, this reports the position in the run.

            Closing an item and ticking are already idempotent, so this is for reporting rather
            than for guarding: a catch block can simply call Write-ConsoleResult.

        .EXAMPLE
            if ((Get-ConsoleStatusState).ItemOpen) { Write-ConsoleResult -Status FAIL }

        .EXAMPLE
            $state = Get-ConsoleStatusState
            "stopped after $($state.DoneSteps) of $($state.TotalSteps)"
    #>
    [CmdletBinding()]
    ...
    return [PSCustomObject][ordered]@{
        # True between Write-ConsoleItem and Write-ConsoleResult.
        ItemOpen   = $cfg.ItemOpen
        # Title of the section the item sits under, from the last Write-ConsoleSection.
        Section    = $cfg.Section
        Label      = $cfg.CurrentLabel
        Value      = $cfg.CurrentValue
        # Units of work declared by the item, 0 when the total is unknown.
        TotalSteps = $cfg.TotalSteps
        DoneSteps  = $cfg.DoneSteps
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCSZlEVGyZJpxB0
# JOwkTNKocGR9hjXkyr5DhFNuG8qdEKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgJRPd
# S8l7dMP4bme/TIbCqFz5KJG+AJI6ySGyuSlbGuUwDQYJKoZIhvcNAQEBBQAEggGA
# EDCwGvgiuIFHjyBFvcTKTD7Jr13mCGyfJXpuMIemYbp/8iB9RrB2lG/0a/68SRfy
# sqEatPqgg2kpUBfVM5dLYFsYPoQ4PpdHHzugT6EoqahFjP7Fi3CMH2uMfZTza8lY
# F6CqUX6ihVMuSINB95BwRSJrTyVsT77a1FmiCCjbD6B22VaFGhsj+1FglZYmiRFJ
# x7aailSKEhmFmbM65S9nk0a4OGYfF9JhihkXORha0Ic1u1pZgyAx5T6R7f5sVWFO
# Xj+crMruuTem7bP4BAjAl+0Torxk6NHbTXPW5mdUO6uEJwP+VCfWRDEu8njn5bAj
# On+PXvbGEGVKYN9oXQlh7t8gx8mJePAexq0jpBzgUaW1cnN+oMyt10Ts8fbC65mg
# gxx4oL3uNJ0x//GbpprSpwaAqo/E4erSmHOdzGhXVApztw/k/tS/7NzAu53OHD6j
# hrWhpsfFn/lJmGoJJkt3UbQBfhv+d+LZmelUqZoOvkrjZ6zz7uS+2z06oI79SGZI
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIL2Zi11r4zD2YLRyOK9C
# /wS1N4wYdMWA+33H6zmcFlDYAgZqNTB5fz8YEzIwMjYwODEyMjEyNzM2LjM2Nlow
...
# IgQgbNSW1DR3yRS6Vp/jumfaWab+tOxTw2zgkllKeX64NdYwgd0GCyqGSIb3DQEJ
...
# 8eu6iE+ys2Gla/OL9Xks4QhzNDANBgkqhkiG9w0BAQsFAASCAgB5PgpDahmjUSoU
# U4ac8/OHwds+Ks2d3EUJ2F5CqaQXP2IL3T4P0dzh0PmEzIrFkMTc+Y5FcO1OApLH
# rOVb9k24EpqN0OYuhKaZClxKmalegJguyaHdDoq+qwpc0GZ0VW5Kl8tluMWEviVN
# ndFRw0LSnTtfqDKoSEWeFZ34tH97gIdXhIdmZVY7TM/0Hp+G8TM5LS8LRv1ynU4b
# MEAkcMzJJqBQbO8ANi2AoQveZcxD/SLfUAWM9D/mOhNhsXnni8qbkXqIY/gL4bDb
# vJQ6HwZ3YBJKn6rHOaWMm3WT60xWRK2zPWPO4j1LyCUEXL8W5Oc5BMyMn/ETiPzv
# Li1KKmFKdqfkH/dzAsUq5vsFX9uOpqP67YGSSkIcSnb8WCN3qIVGQF2tetARlGTm
# nL+ar+9sUqI8FAlYhha+llIzJHwr5PXAduPd3i0Wt4bNO4xliKbdPjrRcYyd+mIN
# /ferbDBsJuUtOKGtg8ivMKCn8SMXgq8EREi/KivRI0Fm3XcsxO45iTLrkpEXdyb4
# xoSy1C7WMZinO2m32pr2wNNPuF9JsM7ZNjG4xlIOqkTO5Qmfmx/n50MXgHlQtUfg
# PNTgnoBpbbsTXOEPA1R8+pLcrmTf0UU4XU0s1INFwBjk9nmDKKwFl7oNizmLsm+7
# h+0/B5HS9/cGP8NDBtyrwai1Rlxrvg==
