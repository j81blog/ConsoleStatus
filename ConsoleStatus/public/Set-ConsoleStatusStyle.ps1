function Set-ConsoleStatusStyle {
    <#
        ...
        .PARAMETER TitleChar
            Single character the rules above and below a title banner are drawn from.
            Defaults to an equals sign.
    ...
    $glyphKeys = @('TickChar', 'FillChar', 'RuleChar', 'TitleChar', 'MoreChar')
    $explicitGlyphs = @{}
    ...
    if ($cfg.Unicode) {
        ...
        $cfg.TitleChar = [char]0x2550  # box drawing double horizontal
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCO6RyhJZFOqHBn
# 3nqIjkdKOCVUoeOx4tr5b1j+46ZoSaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgzk6j
# EfyPZgdawXj5NbplwRpIm3K1iQXeVdMHALbGufIwDQYJKoZIhvcNAQEBBQAEggGA
# JgfTyaXO3eIXOjYhAKp56cqiAerP781X5ObnkJRwJC+b6NM9e7prEXqBBw/ygvZ1
# IitRoAbkmRSZTWbvRogbW4lP+NoMD9Zr24DLWDv+Jj+hWKazG30j1geYTGDjvzbG
# LY/V6tvt5Cs1MD5HYaLLg8Mw3IXLXlGIX7hZ2iF+Sxj6ydE97I14rTsnMpoGyIZx
# q4V1ZkC8HeYb1dEHu8zxpiYhdDJVc+6RRSzKyKV+Zx294B1qPeYL1aKqVrJmdt+z
# 6OLBey6kgZ1OP/5CYTkGG2J7+viWv7QJhwptBujpAzP2x2Qjb4GQERXaiGXks8eq
# Q805JSNhSFJ84S/5yPv8L4iHTR/9muhIr1sIB87azf8iLpAHF2P8iikZ/ybsn1BR
# 497HFoHmHZwEyi/p1RcUZJgdYaW3+iOVuVoqJiOumyiA7TuY//1G4U5f+VyLXkmG
# 6EQxUayCRpqp93L78znzttbApLQs6oiDgROAPAAKVHTZ7tRfphsrEgOPPsQpaXqp
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIIRdqGC4442ieAQC9KuE
# 4xOvqY9CW/twGX320hDlI9faAgZqNTB5Zb0YEzIwMjYwODEyMTk1NTQ3Ljg0N1ow
...
# IgQgFlOTFGhrE05h0iuzVt/NO8v6IojH7ZuKSypwLOweFFYwgd0GCyqGSIb3DQEJ
...
# 8eu6iE+ys2Gla/OL9Xks4QhzNDANBgkqhkiG9w0BAQsFAASCAgBibPu/XPpq37Js
# wCEfXHC1OgdJ2u9+d2geIyiYSgKPpAD1zrDpVVEAWYVAUokDs2JAsrXfY0w9IQ0T
# EMosD84HG5HLQEyZp3kaO22tpBcVIh0CwMHjRPW7ax3Z7UvtJbis+NzdapiygJNo
# YQt7MfBhRFjAb5KESvlTuNDBCd78xGr4QzV2jdzeD9clj4WlGlhzxDTD2gS0i/hD
# GdAuhFcge87YlqpALHrP/wI7WOBITf2IIFmwmcXTbzTkQfviepSqBtAV/UhlyBE3
# d7jJ5McfpJohlBkUvyQlQUKDDlx2OfJ2+ja8vzusewEmp2T28DGJXwILMfyBJkyu
# MaxNcCbzUTPnlMot0OqB9i8TpKuKdqAbb/b0IHdVi/ODxNS+HtoietDItnBqNOus
# eMlE/cP86d/y6mhJAtmOsTGvld0a73coKy6jgjRQYUWZmGaEWlVann36HeClok7L
# Sk6wgMDqO7H7s+Nrmr5etQpOnRrqfxL6P50wcWe3Bd0CzoJj+a0gZyooMGGcXrd6
# bdo3NkTUM/RF9/3TjwAn5Z3EIXX3SpMI8GfvTv4F9oMamhgtDhMr5XEi+3mducQA
# LXOUYNTPA5IDD7GmXNQ4vNQQgmbZsS+ozsowfUTwZRPUybj+pWY3efkJNNfeZy7M
# o38o/ep8AP5YTHmXfaD5bPRXYyGwew==
