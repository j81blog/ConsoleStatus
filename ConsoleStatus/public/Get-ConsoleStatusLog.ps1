function Get-ConsoleStatusLog {
    <#
        .SYNOPSIS
            Returns one structured record per completed item.

        .DESCRIPTION
            Ready for JSONL with ConvertTo-Json -Compress, one record per line.

        .EXAMPLE
            Get-ConsoleStatusLog | ForEach-Object { $_ | ConvertTo-Json -Compress } | Set-Content -Path 'run.jsonl'
    #>
    [CmdletBinding()]
    [OutputType([PSObject[]])]
    param()

    return $script:ConsoleStatusLog.ToArray()
}

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDhCFWLLvxxdS4b
# MVgT8IYAXkJTMIS1RTAb3cK1BjcEGaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg157A
# m+jadbA6PztXQzt5KJDKHYsgYEw6LVslidTb63MwDQYJKoZIhvcNAQEBBQAEggGA
# WOf1qblikIg93QVlsg0a+bOrGwzLIo83vS9BSIw2S0LjFUAs6z6wJ1Ka7ix1DCai
# r05JvrxHQ61Xsw/ILgbXEMdfpXdnD5pf7fJwJSs7GjKCGS0JRI8rCTWwYJDL82LX
# CmAYMXbDEm/i5XYP+6us/DYo2sgICNoQeccmvNR876tE47ohPhJhxrFRhlxKuwkg
# SJUZ+5AS/ef3bOmSd36Z9S4tWl0HapgwJVW1Xpcc8/i3QtHKn77TKEpW2qbquvoh
# Y5CkE6pcbhPKMFqjJCl/xi07L1XzBvlwuWr6giFDRUFQzEnH+/Wn+ezfnLnsftVq
# gcWDfUDEssul7NvDnkdkMLsGmM4kGB8dYubXlJXavOI8+xw0mf8I/Xw1+BGK786T
# pzv5PSdM70Zmfg/V0r6VkI4O0cI3I8Pk3RVV/xatGs1IVTuhdhM5gbY0hL/B4eJF
# r9GSLWEB43JzKs1Yx7E5ULVK8ckWVvQJz+WcGIGigv/xkMjXCTMdBzqDY34zNprn
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEII9S9weFkUdyXS0bvrvU
# imjVDhDasbfDUnBa7V451zz3AgZqNTBzBYQYEzIwMjYwODEwMjA0NzQ0LjM2MVow
...
# IgQgm/wFxkFSs93KDzy/E+ux30owQ9wAD0TKHeZTfkvLDo4wgd0GCyqGSIb3DQEJ
...
# r2m/ztk0VK82Yn22ky/ozUOgUzANBgkqhkiG9w0BAQsFAASCAgAQff98jHuM8nf2
# +IdaUJstG714XwM0/SJYJMHR0lhGFt/7Fgv9sJ+pVpPX5IeF8/C/UBboRwdYQkvV
# p19PSfF1mnvWWPOwRDtoEVFPplvjvao9Vlid+WrmMgbwSfwIXcgkfpgFcPyoJAWI
# KH9Td1rQeSKvuVsqwF/cJY3WKkcDkyCTGClV+I4XwK2JqZdlPmlrl5R+5WZZt31F
# Bq/cQJj8jfI6eS+UrB+y9ydL5oXstuS2YsYN3geTKNgoW6EL8ec8jwzyuNveaves
# tvQJdygWeF/qYjl6RgAtUyDCOkV8bzh2GQ4qU+mbA3rwgDNlHPpJZDGGDSLV7xOA
# AW9wD76UrP8G2wuaP5Mj39OPQ77aOkFZFPmlVAxmSBnlDL6fimnY2RPIromjYp+D
# 9qqSAbD5HBdOfi6CP9x2AR5+Ji1Q1i15ntCMHkrKVF7f2Rg/DeaB3ds5Jw3cxKIO
# 8sBZWiQ1An7+VNbNghbOtieph9P988myixB1dMi0901AaRMiNWC4QKI9zSbo39Ke
# hFfWwIktfPnLH18yVBv0/RP1IvlLHKUVIUz6VhZGvNHF4pKDZpo2yz12+E6GdM+0
# s8yq83oLCxxVw9i/LxVn5ZcFPtGr8wT7OwTKQJTlVT9Wv3oRmtFdymEpBkfJUJjl
# n6EJ8oxPQD/xFv/LGvTkwHORtgTKdA==
