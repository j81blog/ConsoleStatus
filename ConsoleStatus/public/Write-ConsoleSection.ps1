function Write-ConsoleSection {
    <#
        .SYNOPSIS
            Writes a section header with a rule underneath.

        .DESCRIPTION
            The title is also stored on every following log record until the next section.

        .PARAMETER Title
            Section name. Whitespace is collapsed, so it stays on one line.
    ...
    $cfg.Section = Format-SingleLine -Text $Title
    $indent = ' ' * $cfg.Indent
    $rule = [string]$cfg.RuleChar * ($cfg.LineWidth - $cfg.Indent)

    Write-HostText -Text ''
    Write-HostText -Text "$indent$($cfg.Section)" -Color 'White'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA1uQ4yPZKLP4a6
# Mm51I2JWlhz+I7ATEQ4VCGtZIKl/PqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg6H5s
# YlncbimjEMlOHBXcxgl/mnyebYabvlVJq9x2RpIwDQYJKoZIhvcNAQEBBQAEggGA
# hjyfQ/m9HZO0PViztj9fajDHXvKQSsTIBAlVPSN7plu91giGHIyLg6mKLdWVQrV2
# DTo6EH3ZU2ZIi8zLnGGB5jlhFqEkBWXbBb26V35nfp7sRtY7ZXs6neowh8GNbDPY
# xq/XqVzzLeXvnkSlNwN5TMopiT3C9v7G9IkWisQ/4gWZTJUDgdP8+J9qQ+NV0iSw
# gdhamIag0lHc6Q3me2BTGLchWd+f6/ImjeUOQHCNvKphHDJoAdZa5MxegpxppKur
# eUF6w1XjWG1zZpbL/ZNtNfGLe5U1iuA34vDPyk+9NOlqqs69dUovX3e+zREx7mOr
# /7y2WzLmKZak7eusZcR4MH/CrOPMQ+h3/+GL7OatVaRpYjBnXLO77TxsxboA2Pop
# ouApZxp79HgisMUhC3Um1Rn54/SqB/0qGSUTs833INVChAwl+muzp2UefRy7hu6X
# Zjy1yMSKRnFfe6hqa5aRAvnTQeAYOmixuIdO4smUFp+gN6wHpT3FgORMIxLah1FZ
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEILXkSLGW0zc5/Bqo1jgz
# cly/SNcSmQtFg79UlBWaaksAAgZqdgnSP1sYEzIwMjYwODEwMjA0ODAzLjMzM1ow
...
# IgQgY1uudsRBMFkp6f92Bt3DptMX91xYrBxSNMMroMDSaFMwgd0GCyqGSIb3DQEJ
...
# PSanbLLmZ+tZpRgaUQwIiab9pTANBgkqhkiG9w0BAQsFAASCAgCP8eAsYCcZtFTz
# mwMeMDIyxSlvLzFi3addn/lbwYc8KyrSZTdypXvd+ql0MmltPA5NeAfZazq9fQ08
# TadjwxaFI3lYOzTzy6ixAPLjBfoJPtIVsZp68AE+LyCofqXr8naZZVlFFLLPwTfm
# 0KArBbg/j4uD80EdW+FV6o1eWoADfFF6TeH6gicdNkxG4uNfxK4EE0XNaRD0bWSM
# /K9wNzu95rh36Po1AuEBlIsc58TkJsSfHjipJoW8sH6rTODWF2qK0Kbg7tXc/GsC
# yOuxxkbB7mp0BqFiFUIp6zfuu8FMRdBD3yDdI8VcoW84t6RSIJ++NMyWTw527RIN
# nuew2zC8tuIDSd4qZlAq3njrxAa078UCN97lDawiBipxdTV1wwjmTfTMh3kNnDns
# WAvnUbu8ZQE/LzDGx9AKIdkbSGt89Q8ji/BOVN5EHa1xQIfxgZt11r8eD3tOz/Nk
# XpMqI8x+4KU6OoODYN8i4h0RXGic6s9AND7xeWGIgf3mRNaAMSUFDJwQdeW8gtbj
# Sf1UuO9PFu5d6P8XLbxQsQVUmbUJwxm/jJSnzb5oUQFL2vXvjcVC5EcuTkOI2jNE
# zA834mzae+dwC7w6iNIGiWTa6RFHurCClPJrTLMXy51U84VRkIVpfRsUHQrZMsTr
# VF015G9uPXb6ZCl3psxDarZh35nVkQ==
